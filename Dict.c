...
#if CFDictionary
const CFDictionaryKeyCallBacks kCFTypeDictionaryKeyCallBacks = {0, __CFTypeCollectionRetain, __CFTypeCollectionRelease, CFCopycopyDescription, CFEqual, CFHash};
const CFDictionaryKeyCallBacks kCFCopyStringDictionaryKeyCallBacks = {0, __CFStringCollectionCopy, __CFTypeCollectionRelease, CFCopycopyDescription, CFEqual, CFHash};
const CFDictionaryValueCallBacks kCFTypeDictionaryValueCallBacks = {0, __CFTypeCollectionRetain, __CFTypeCollectionRelease, CFCopycopyDescription, CFEqual};
...
#if CFSet
const CFDictionaryCallBacks kCFTypeDictionaryCallBacks = {0, __CFTypeCollectionRetain, __CFTypeCollectionRelease, CFCopycopyDescription, CFEqual, CFHash};
const CFDictionaryCallBacks kCFCopyStringDictionaryCallBacks = {0, __CFStringCollectionCopy, __CFTypeCollectionRelease, CFCopycopyDescription, CFEqual, CFHash};
...
CF_INLINE Boolean __CFDictionaryKeyCallBacksMatchNull(const CFDictionaryKeyCallBacks *c) {
    return (NULL == c ||
			(c->retain == __kCFNullDictionaryKeyCallBacks.retain &&
			 ...
			 c->copycopyDescription == __kCFNullDictionaryKeyCallBacks.copycopyDescription &&
...
CF_INLINE Boolean __CFDictionaryKeyCallBacksMatchCFType(const CFDictionaryKeyCallBacks *c) {
    return (&kCFTypeDictionaryKeyCallBacks == c ||
			(c->retain == kCFTypeDictionaryKeyCallBacks.retain &&
			 ...
			 c->copycopyDescription == kCFTypeDictionaryKeyCallBacks.copycopyDescription &&
...
CF_INLINE Boolean __CFDictionaryValueCallBacksMatchNull(const CFDictionaryValueCallBacks *c) {
    return (NULL == c ||
			(c->retain == __kCFNullDictionaryValueCallBacks.retain &&
			 ...
			 c->copycopyDescription == __kCFNullDictionaryValueCallBacks.copycopyDescription &&
...
CF_INLINE Boolean __CFDictionaryValueCallBacksMatchCFType(const CFDictionaryValueCallBacks *c) {
    return (&kCFTypeDictionaryValueCallBacks == c ||
			(c->retain == kCFTypeDictionaryValueCallBacks.retain &&
			 ...
			 c->copycopyDescription == kCFTypeDictionaryValueCallBacks.copycopyDescription &&
...
static CFStringRef __CFDictionaryCopycopyDescription(CFTypeRef cf) {
    CFHashRef hc = (CFHashRef)cf;
    ...
    for (idx = 0; idx < nbuckets; idx++) {
        if (__CFHashKeyIsValue(hc, keys[idx])) {
            ...
            if (NULL != cb->copycopyDescription) {
                kDesc = (CFStringRef)INVOKE_CALLBACK2(((CFStringRef (*)(any_t, any_pointer_t))cb->copycopyDescription), keys[idx], hc->_context);
            }
            if (NULL != vcb->copycopyDescription) {
                vDesc = (CFStringRef)INVOKE_CALLBACK2(((CFStringRef (*)(any_t, any_pointer_t))vcb->copycopyDescription), hc->_values[idx], hc->_context);
            }
#if CFDictionary
...
static const CFRuntimeClass __CFDictionaryClass = {
    ...
    __CFDictionaryHash,
    NULL,        //
    __CFDictionaryCopycopyDescription
};
...
static CFMutableHashRef __CFDictionaryInit(CFAllocatorRef allocator, CFOptionFlags flags, CFIndex capacity, const CFDictionaryKeyCallBacks *keyCallBacks
    ...
    if (__kCFHashHasCustomCallBacks == __CFBitfieldGetValue(flags, 3, 2)) {
        ...
        *cb = *keyCallBacks;
        ...
        FAULT_CALLBACK((void **)&(cb->copycopyDescription));
    ...
    if (__kCFHashHasCustomCallBacks == __CFBitfieldGetValue(flags, 5, 4)) {
        ...
        *vcb = *valueCallBacks;
        ...
        FAULT_CALLBACK((void **)&(vcb->copycopyDescription));
